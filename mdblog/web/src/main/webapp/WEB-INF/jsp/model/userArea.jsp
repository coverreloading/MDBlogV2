        ...
        <div class="col-xs-16 main">
            ...
            <div id="list-container">
                ...
                <ul class="note-list" infinite-scroll-url="/u/e832b926acf9?order_by=shared_at">
                            ...
                            <div class="content">
                                <div class="author">
                                    ...
                                    <div class="name">
                                        ...
                                        <span class="time" data-shared-at="">{{ x.raCreatetime | date:'yyyy-MM-dd HH:mm:ss' }}</span>
                                    </div>
                                </div>
                    ...
                    <button ng-show="getmore" class="btn load-more" style="margin-bottom:100px;"
                            ng-click="getmore(num)">点击加载更多
                    </button>
                </ul>
