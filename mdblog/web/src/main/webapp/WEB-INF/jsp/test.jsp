        ...
        <div id="page-wrapper">
            <div style="position: relative">
                ...
                <div id="updateSuccessMsg" hidden="hidden"
                    ...
                    <a class="btn  btn-block btn-lg" style="background-color: #5cb85c"><span style="color: #d9edf7">自动保存成功</span></a>
                </div>
                    ...
                    <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <button class="btn btn-primary" ng-click="downloadArticle('md')">MarkDown
                                </button>
                                <button class="btn btn-primary" ng-click="downloadArticle('html')">HTML
                                </button>
                            </div>
                ...
                <div class="modal fade release-article-modal" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-warning" ng-click="releaseArticle()">发布</button>
                ...
                <div hidden="hidden">
                    // 临时放置被选中文章各参数 {{articleInActiveaId}}
                    <br/> {{articleInActiveaTitle}}
                    <br/> {{articleInActiveaText}}
                    <br/> {{articleInActiveaCreatetime}}
                    <br/> {{articleInActiveaUpdatetime}}
                    <br/> {{articleInActiveaDel}}
                    <br/> {{articleInActiveaUid}}
                    <br/> {{check}}
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    $(function () {
        testEditor = editormd("test-editormd", {
            ...
            imageUploadURL: "/pic/uploadfile/${token}",
