        ...
        <div id="page-wrapper">
            <div style="position: relative">
                ...
                <div style="width: 100px;height: 20px;position:absolute;right:15px;bottom: 210px;">
                    <a class="btn btn-info btn-block btn-lg" data-toggle="modal" data-target=".release-article-modal">发布</a>
                </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <h3>标题</h3><input class="form-control bg-info " type="text" name="raTitle" ng-model="raTitle">
                                </div>
                                <div class="form-group">
                                    <h3>标签</h3><input class="form-control bg-info " type="text" name="password" >
                                </div>
